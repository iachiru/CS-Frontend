...
//navigate("/") //this is to change to go to profile This is redirecting even if the register is not succesful. Review
}
  ...
  return (
    <>
      ...
      <Form.Group className="mb-3" controlId="formBasicName">
        ...
        <Form.Control type="name" placeholder="Enter your full name" value={name} onChange={(e)=>{setFormData({...formData, name: e.target.value})
     setError("")
...
<Form.Group className="mb-3" controlId="formBasicPassword2">
        ...
        <Form.Control type="password" placeholder="Confirm password" value={password2} onChange={(e)=>{setFormData({...formData, password2: e.target.value})
      setError("")}} />
      </Form.Group>

     <Form.Group className="mb-3" controlId="formBasicCheckbox">
        <Form.Check type="checkbox" label="Host" checked={formData.host} onChange={(e)=>{
